            ...
            <div id="menu">
                ...
                <div className="btn-grid" id="dsd-grid">
                    <GameCard
                        ...
                        thumbnail="https://uwohci23.github.io/Group-7-Project/art/deepSeaDuel/dsdThumb.png"
                        title={1}
                    /></div>
                <div className="btn-grid" id="gg-grid">
                    <GameCard
                        onGameNum={this.props.onGameNum}
                        thumbnail="https://uwohci23.github.io/Group-7-Project/art/groupingAndGrazing/Cow2.png"
                        title={2}
                    /></div>
                <div className="btn-grid" id="cb-grid">
                    <GameCard
                        onGameNum={this.props.onGameNum}
                        thumbnail="https://uwohci23.github.io/Group-7-Project/art/coinBox/quarter2.png"
                        title={3}
                    /></div>
                <div className="btn-grid" id="or-grid">
                    <GameCard
                        onGameNum={this.props.onGameNum}
                        thumbnail="https://uwohci23.github.io/Group-7-Project/art/oktasRescue/okatThumb.png"
                        title={4}
                    /></div>
            </div>
        )
